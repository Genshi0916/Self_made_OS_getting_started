...
struct SHEET *open_console(struct SHTCTL *shtctl, unsigned int memtotal)
{
	...
	unsigned char *buf = (unsigned char *) memman_alloc_4k(memman, 800 * 600);
	sheet_setbuf(sht, buf, 800, 600, -1); /* �����F�Ȃ� */
	make_window8(buf, 800, 600, "console", 0);
	make_textbox8(sht, 8, 28, 784, 563, COL8_000000);
